...
import {ConfidentialFungibleTokenUtils} from "@openzeppelin/confidential-contracts/token/utils/ConfidentialFungibleTokenUtils.sol";
import {FHECompat} from "./FHECompat.sol";
...
abstract contract ConfidentialFungibleToken is IConfidentialFungibleToken {
    ...
    function finalizeDiscloseEncryptedAmount(
        ...
        FHECompat.checkSignatures(requestId, signatures);
